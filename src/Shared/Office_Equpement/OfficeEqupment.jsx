...
function OfficeEqupment() {
  ...
  // Filter only laptops
  const LaptopData = products.filter((product) => product.category === "OfficeEqupment");
  ...
  return (
    <div className="mt-28 min-h-screen bg-gray-100 p-4">
      <h1 className="text-2xl font-bold mb-6 text-center">OfficeEqupment Catalog</h1>
